#creating a ceasar cipher program
#create a user defined function
def getDoubleAlphabet(alphabet):
    doubleAlphabet = alphabet + alphabet
    return doubleAlphabet
    
    #this is to input the message to be encrypted
def getMessage():
    stringToEncrypt = input("Please enter a message to encrypt: ")
    return stringToEncrypt
    
    #this is to input the cipher key
    #it will determine how the message would be encrypted.
def getCipherKey():
...
def encryptMessage(message, cipherKey, alphabet):
    encryptedMessage = "" #this defines the encrypted message as a variable
    uppercaseMessage = ""
    uppercaseMessage = message.upper() #this ensures that the message inputed is capitalized
